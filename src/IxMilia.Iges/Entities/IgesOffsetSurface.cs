...
namespace IxMilia.Iges.Entities
{
    public class IgesOffsetSurface : IgesEntity
    {
        ...
        public IgesOffsetSurface(IgesFile file)
            : this(file, IgesVector.ZAxis, 0.0, null)
        {
        }

        public IgesOffsetSurface(IgesFile file, Vector3D direction, double distance, IgesEntity surface)
            : base(file)
        {
            Direction = direction;
            Distance = distance;
