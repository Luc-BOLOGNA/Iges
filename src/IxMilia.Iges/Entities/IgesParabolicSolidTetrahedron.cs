...
namespace IxMilia.Iges.Entities
{
    public class IgesParabolicSolidTetrahedron : IgesFiniteElement
    {
        ...
        public Point3D P4P2Control { get; set; }
        public Point3D P4P3Control { get; set; }
        ...
        public IgesParabolicSolidTetrahedron(
            ...
            Point3D p4P3Control,
            Point3D p4)
            : base(file, IgesTopologyType.ParabolicSolidTetrahedron)
        {
            P1 = p1;
        ...
        protected override void AddNodes()
        {
            ...
            InternalNodes.Add(new IgesNode(File, P4P2Control));
            InternalNodes.Add(new IgesNode(File, P4P3Control));
